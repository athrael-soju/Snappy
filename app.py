...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    gr.Markdown("# ColPali: Efficient Document Retrieval with Vision Language Models (ColSmol) 📚")
    gr.Markdown("""Demo to test ColSmol (ColPali) on PDF documents. 
    ColSmol is model implemented from the [ColPali paper](https://arxiv.org/abs/2407.01449).
