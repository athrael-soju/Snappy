...
The hybrid approach with P50 filtering reduces context tokens by 28.8\% compared to returning all OCR regions and by 52.3\% compared to full-page image tokens. These savings directly reduce LLM inference costs and context window usage, consistent with the theoretical bounds in \Cref{cor:tokens}.
...
\textbf{Parameter Sensitivity at P75.} Higher percentile thresholds introduce meaningful parameter sensitivity. \Cref{tab:ablation} presents the P75 results.
