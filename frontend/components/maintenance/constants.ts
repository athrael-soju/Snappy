...
export const MAINTENANCE_ACTIONS: MaintenanceAction[] = [
  {
    ...
    confirmMsg: "⚠️ WARNING: This will permanently delete ALL data from Qdrant (and MinIO if enabled). This includes all documents, embeddings, images, and search indices. This action cannot be undone and will reset the entire system to its initial state.",
