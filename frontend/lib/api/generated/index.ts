...
export type { OcrBatchRequest } from './models/OcrBatchRequest';
export type { OcrBatchResponse } from './models/OcrBatchResponse';
export type { OcrDocumentRequest } from './models/OcrDocumentRequest';
export type { OcrPageRequest } from './models/OcrPageRequest';
