...
from services.deepseek_ocr import DeepSeekOCRService
...
def get_deepseek_client() -> DeepSeekOCRService:
    """Return the cached DeepSeek OCR client."""
    global deepseek_init_error
    try:
        service = _get_deepseek_client_cached()
