...
class RequestIDMiddleware(BaseHTTPMiddleware):
    ...
    This enables distributed tracing across services by:
    1. Extracting or generating a request ID
    2. Storing it in a context variable for logging
    3. Adding it to log records via custom factory
    4. Including it in response headers
    """
