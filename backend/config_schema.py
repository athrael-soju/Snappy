    ...
    "duckdb": {
        ...
        "settings": [
            ...
            },
            {
                ...
                "help_text": "OCR results are batched before sending to DuckDB for efficiency. Higher values (20-50) reduce network overhead but increase memory usage. Lower values (5-10) provide more frequent updates. Default 10 balances performance and responsiveness.",
                "depends_on": {"key": "DUCKDB_ENABLED", "value": True},
            },
            {
