    ...
    "deepseek_ocr": {
        ...
        "settings": [
            ...
            },
            {
                ...
                "help_text": "Maximum time to wait for OCR responses. Increase for longer documents or CPU-only deployments; decrease for fast GPU hosts to catch misconfigurations quickly.",
                "depends_on": {"key": "DEEPSEEK_OCR_ENABLED", "value": True},
            },
        ],
    },
