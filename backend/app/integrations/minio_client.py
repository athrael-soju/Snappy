...
class MinioBucketStat:
    """Lightweight statistics payload for bucket inspections."""

    name: str
    object_count: int
    size: Optional[int] = None  # total bytes; optional when not available
...
__all__ = ["MinioClient", "MinioBucketStat"]
