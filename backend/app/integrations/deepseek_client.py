...
class DeepSeekOCRRequestError(RuntimeError):
    ...
    def run_ocr(
        ...
        *,
        ...
        try:
            ...
            message = f"DeepSeek OCR request failed: {exc}"
            raise DeepSeekOCRRequestError(message) from exc
...
__all__ = ["DeepSeekOCRClient", "DeepSeekOCRRequestError"]
